# ============================================================
#################################
# addonwindow.py by Code-E-Magpie
#################################
# ============================================================

# sourced from: plugin.program.aliundek19gui.maintenance.wizardz > resources > libs > addonwindow.py
# location: plugin.program.maintenance-toolbox > resources > lib > common > addonwindow.py
# type: common
# functionality: PyXBMCt framework module 
#	- PyXBMCt is a mini-framework for creating Kodi (XBMC) Python addons with arbitrary UI Controls
#	- contains all classes and constants of PyXBMCt framework
#	- derived from xbmcgui.Control class
#	- framework uses image textures from Kodi Confluence skin
# development:
...
_images = configuration.SKINS_MEDIA
ADDON_PATH = configuration.ADDON_PATH
skin = Skin()
...
# Kodi key action codes. More codes available in xbmcgui module.
