# ============================================================
#################################
# addonskin.py by Code-E-Magpie
#################################
# ============================================================

# sourced from: plugin.program.aliundek19gui.maintenance.wizardz > resources > libs > addonskin.py
# location: plugin.program.maintenance-toolbox > resources > lib > common > addonskin.py
# type: common
# functionality: skin
